...
<html lang="ko">
<head>
<title>게시판 파일 글쓰기 | 투어리스트인투어 </title>
...
<div id="wrap">
	...
	<div id="container">
		...
		<div class="bodytext_area box_inner">
			<!-- appForm -->
			<form action="./BoardFileWriteAction.bo" method="post" class="appForm" enctype="multipart/form-data">
				<fieldset>
					...
					<ul class="app_list">
						...
						<li class="clear">
							...
							<div class="app_content">
								<input type="text" name="subject" class="w100p" id="subject" placeholder="제목을 입력해주세요"/>
							</div>
						</li>
						...
						<li class="clear">
							...
							<div class="app_content">
								<textarea name="content" id="content_lbl" class="w100p" placeholder="내용을 입력하세요."></textarea>
							</div>
						</li>
